...
function createGravatar(username) {
    var userHash = (0, _md2.default)(username);
...
},{"crypto-js/md5":6,"jquery":7}],3:[function(require,module,exports){
'use strict';
